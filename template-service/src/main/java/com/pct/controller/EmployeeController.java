...
import com.pct.dto.ResponseBodyDTO;
import com.pct.dto.Status;
...
public class EmployeeController {
	...
	/* @Loggable this is an open issue */
	...
	public ResponseEntity<ResponseBodyDTO<Boolean>> deleteEmployeeDetails(@PathVariable("id") String id) {
		ResponseBodyDTO<Boolean> responseBodyDTO = new ResponseBodyDTO<>();
		responseBodyDTO.setData(employeeService.deleteEmployeeDetails(id));
		responseBodyDTO.setMessage("Employee deleted successfully.");
		responseBodyDTO.setStatus(Status.SUCCESS);
		return new ResponseEntity<>(responseBodyDTO, HttpStatus.OK);
	}
}
